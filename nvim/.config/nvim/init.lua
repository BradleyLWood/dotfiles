...
require('lazy').setup({
  ...
  -- Automatically add your own plugins, configuration, etc from `lua/plugins/*.lua`
 { import = 'plugins' },
}, {})
...
-- [[ Basic Keymaps ]]-- Numberline controls
...
-- Harpoon
vim.keymap.set('n', '<Leader>a', ':lua require("harpoon.mark").add_file()<CR>', { silent = true, desc = "Harpoon - mark file" })
vim.keymap.set('n', '<Leader>hl', ':lua require("harpoon.ui").toggle_quick_menu()<CR>', { silent = true, desc = "Harpoon - list files" })
vim.keymap.set('n', '<Leader>hc', ':lua require("harpoon.cmd-ui").toggle_quick_menu()<CR>', { silent = true, desc = "Harpoon - quick menu" })
vim.keymap.set('n', '<C-h>', ':lua require("harpoon.ui").nav_file(1)<CR>', { silent = true, desc = "Harpoon - file 1" })
vim.keymap.set('n', '<C-j>', ':lua require("harpoon.ui").nav_file(2)<CR>', { silent = true, desc = "Harpoon - file 2" })
vim.keymap.set('n', '<C-k>', ':lua require("harpoon.ui").nav_file(3)<CR>', { silent = true, desc = "Harpoon - file 3" })
vim.keymap.set('n', '<C-l>', ':lua require("harpoon.ui").nav_file(4)<CR>', { silent = true, desc = "Harpoon - file 4" })
